 ...
 * @param outputFormat        Output format for parsed data (JAVA, SBE, JSON)
 */
public record GatewayConfig(
    ...
    private static final OutputFormat DEFAULT_OUTPUT_FORMAT = OutputFormat.JAVA;
     ...
     * - OUTPUT_FORMAT: Output format (default: "JAVA", options: "JAVA", "SBE", "JSON")
     */
    public static GatewayConfig fromEnv() {
        ...
        OutputFormat outputFormat = parseOutputFormatEnv("OUTPUT_FORMAT", DEFAULT_OUTPUT_FORMAT);
    ...
    private static OutputFormat parseOutputFormatEnv(String key, OutputFormat defaultValue) {
